...
# The function needs a different name to sklearn's plot_confusion_matrix
def make_confusion_matrix(y_true, y_pred, classes=None, figsize=(10, 10), text_size=15, norm=False, savefig=False):
    ...
    n_classes = cm.shape[0] # find the number of classes I'm dealing with
...
# (since I'm going to be downloading and unzipping a few files)
import zipfile
